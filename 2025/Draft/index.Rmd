...
```{r}
draftData <- read.csv("./data/Draft2025.csv", stringsAsFactors = F)
...
For 2025 we will be using the top 300 ESPN PPR Superflex rankings

```{r}
rankings <- read.csv("./data/espn_superflex_ppr_2025.csv", stringsAsFactors = F)
