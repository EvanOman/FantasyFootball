...
<nav class="tabs" aria-label="Report sections"><a href="#report" class="active">01 <span>The Report</span></a><a href="#lab" data-lab-link>02 <span>Draft Lab</span></a><a href="../Draft/" class="archive-link">Original knitr page ↗</a></nav>
<main id="main"><section id="report"><div class="hero"><p class="eyebrow">8 teams / 128 picks / PPR superflex</p><h1>The draft,<br>with <em>receipts.</em></h1><div class="hero-bottom"><p class="standfirst">Rome built the best projected lineup. Magic collected the most ESPN value. Those are different achievements, and this draft needs both scorecards.</p><div class="hero-aside"><span>RANKINGS</span>ESPN · September 2<span>PROJECTIONS</span>Mike Clay · September 7<span>ANALYSIS</span>AI-assisted · grades explained below</div></div></div>
...
</section><section id="lab" hidden aria-label="Draft Lab"><h2>Draft Lab</h2><p>The interactive views are being prepared.</p></section></main><footer><span>4TH FLOOR FANTASY / 2026</span><a href="../Draft/">Return to the original knitr analysis ↗</a></footer><script type="module" src="app.mjs"></script></body></html>`;
